...
export const metadata = {
  title: {
    absolute: "درخواست‌یاب | ثبت درخواست خرید و یافتن تأمین‌کننده",
  },
  description:
  ...
  openGraph: {
    ...
    title: "درخواست‌یاب | ثبت درخواست خرید و یافتن تأمین‌کننده",
    description:
  ...
  twitter: {
    ...
    title: "درخواست‌یاب | بازار هوشمند درخواست‌های خرید",
    description:
  ...
  "@graph": [
    {
      ...
      url: SITE_URL,
      description:
        "پلتفرم ثبت درخواست خرید و ارتباط میان خریداران و تأمین‌کنندگان کالا و خدمات",
    },
    {
      "@type": "WebSite",
      "@id": `${SITE_URL}/#website`,
    ...
    },
    {
      ...
      "@id": `${SITE_URL}/#webpage`,
      url: SITE_URL,
      name: "درخواست‌یاب | ثبت درخواست خرید و یافتن تأمین‌کننده",
      description:
        "ثبت درخواست خرید، دریافت پیشنهاد از تأمین‌کنندگان و انتخاب بهترین تأمین‌کننده برای خرید کالا و خدمات",
      inLanguage: "fa-IR",
      isPartOf: {
        "@id": `${SITE_URL}/#website`,
      },
