...
export const metadata = {
  title: {
    absolute: "درخواست یاب | درج آگهی خرید و درج درخواست خرید",
  },
  description:
  ...
  openGraph: {
    ...
    title: "درخواست یاب | درج آگهی خرید و درج درخواست خرید",
    description:
...
const structuredData = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "@id": `${SITE_URL}/#webpage`,
      url: SITE_URL,
      name: "درخواست یاب | درج آگهی خرید و درج درخواست خرید ",
      description:
